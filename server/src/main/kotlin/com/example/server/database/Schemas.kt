...
object Attendances : Table("attendance") {
    ...
    val checkInTime = bigint("check_in_time")
    val checkOutTime = bigint("check_out_time").nullable()
...
object Tasks : Table("tasks") {
    ...
    val actualStart = bigint("actual_start").nullable()
    val actualEnd = bigint("actual_end").nullable()
...
object FileRecords : Table("file_records") {
    ...
    val timestamp = bigint("timestamp")
    val latitude = double("latitude")
    val longitude = double("longitude")
